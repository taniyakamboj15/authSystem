            ...
            <div className="min-h-[calc(100vh-64px)] bg-slate-50 flex items-center justify-center p-6">
                <div className="max-w-4xl w-full">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                        {/* Send File Card */}
                        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-indigo-100 border border-slate-100 hover:shadow-2xl hover:shadow-indigo-200 transition-all duration-300 group cursor-pointer" onClick={() => navigate('/fileshare')}>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mb-2">Send Files</h2>
                            <p className="text-slate-500 mb-6">Upload and share files securely with your team or globally.</p>
                            <span className="text-indigo-600 font-semibold group-hover:translate-x-1 inline-block transition-transform">
                                Go to Dashboard &rarr;
                            </span>
                        </div>

                        {/* Profile Card */}
                        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-purple-100 border border-slate-100 hover:shadow-2xl hover:shadow-purple-200 transition-all duration-300 group cursor-pointer" onClick={() => navigate('/profile')}>
                            ...
                            <p className="text-slate-500 mb-6">Manage your account settings and security preferences.</p>
                            <span className="text-purple-600 font-semibold group-hover:translate-x-1 inline-block transition-transform">
                                View Profile &rarr;
                            </span>
                        </div>
                    </div>
        ...
        <div className="relative w-full overflow-hidden">
            ...
            <div className="container min-h-[calc(100vh-64px)] flex flex-col items-center justify-center text-center py-20">
                ...
                <div className="animate-slide-up max-w-4xl mx-auto px-4">
                    <span className="inline-block px-4 py-2 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-sm mb-6 border border-indigo-100 shadow-sm">
                        🚀 The Future of File Sharing
                    </span>
                    
                    <h1 className="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 bg-clip-text text-transparent leading-tight tracking-tight">
                        Share Files at <br/>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-24 text-left">
                        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-2xl mb-4">🛡️</div>
                            <h3 className="text-lg font-bold text-slate-900 mb-2">End-to-End Secure</h3>
                            <p className="text-slate-500">Your files are encrypted before they leave your device. Only the recipient can open them.</p>
                        </div>
                        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="text-slate-500">Peer-to-peer technology ensures the fastest possible transfer speeds directly between devices.</p>
                        </div>
                        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            <div className="w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center text-2xl mb-4">∞</div>
                            <h3 className="text-lg font-bold text-slate-900 mb-2">No Limits</h3>
                            <p className="text-slate-500">Share files of any size. No bandwidth caps or storage restrictions for pro users.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Footer */}
            <footer className="w-full py-8 border-t border-slate-100 bg-white/50 backdrop-blur-sm mt-auto">
